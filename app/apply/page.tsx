...
import { Loader2, Store, User, Mail, Phone, MapPin, Building2, MessageSquare, AlertCircle } from "lucide-react";
...
export default function ApplyPage() {
    ...
    const checkAuth = async () => {
      try {
        ...
        if (res.ok) {
          ...
          const storeCheck = await fetch(`/api/stores/check?email=${encodeURIComponent(userData.email)}`);
          if (storeCheck.ok) {
  ...
  const handleBusinessNameChange = (value: string) => {
    ...
    if (!formData.shopSlug || formData.shopSlug === generateSlug(formData.businessName)) {
        ...
        <Card className="max-w-md w-full">
          ...
          <CardContent>
            <a href="/auth/login?returnTo=/apply">
              <Button className="w-full bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800" size="lg">
            ...
            <p className="text-sm text-gray-600 text-center mt-4">
              We use Google Sign-In to verify your identity and pre-fill your application.
            </p>
          </CardContent>
        </Card>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-blue-50 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8 space-y-2">
          ...
          <h1 className="text-3xl lg:text-4xl font-bold text-gray-900">Apply to Join Ralli</h1>
          <p className="text-lg text-gray-600">
            Tell us about your business and we'll review your application within 24-48 hours
          </p>
        </div>
        ...
        <Card className="mb-8 border-emerald-200 bg-emerald-50">
          <CardContent className="flex items-center gap-4 p-4">
            ...
            <div>
              <p className="font-medium text-gray-900">Signed in as {user.name}</p>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {slugAvailable === true && <span className="text-emerald-600 text-sm">✓ Available</span>}
                  {slugAvailable === false && <span className="text-red-600 text-sm">✗ Taken</span>}
                </div>
                <p className="text-sm text-gray-600">
                  This will be your kiosk URL. Use lowercase letters, numbers, and dashes only.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="badminton-club">Badminton Club</SelectItem>
                    ...
                    <SelectItem value="racquet-specialist">Racquet Specialist</SelectItem>
              ...
              <Alert>
                ...
                <AlertDescription>
                  We review all applications manually to ensure quality. You'll receive an email within 24-48 hours with next steps.
                </AlertDescription>
              </Alert>
